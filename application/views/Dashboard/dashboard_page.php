  ...
  <script>
    $(function() {
      ...
      var options = {
        ...
        series: [{
          name: "Blast",
          data: [10, 41, 35, 51, 49, 62, 69, 91, 148, 87, 77, 69, 41, 35, 51, 49, 62, 69, 91, 148, 87, 77, 69]
        }, {
          name: "Deliver",
          data: [33, 43, 37, 53, 51, 65, 72, 94, 151, 54, 80, 90, 43, 37, 53, 51, 65, 72, 94, 151, 54, 80, 90]
        }, {
          name: "Activated",
          data: [65, 40, 33, 52, 46, 68, 67, 92, 178, 65, 88, 70, 40, 33, 52, 46, 68, 67, 40, 33, 52, 46, 68]
        }, {
          name: "PS",
          data: [18, 48, 33, 59, 39, 67, 63, 81, 138, 49, 72, 88, 48, 33, 59, 39, 67, 63, 43, 37, 53, 51, 65]
        }],
        dataLabels: {
          enabled: false
        },
