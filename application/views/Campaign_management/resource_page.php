                                ...
                                <div class="row">
                                  ...
                                  <div class="col-md-6 mb-3">
                                    ...
                                    <option value="">-- Pilih Channel --</option>
                                      <?php foreach ($tampil_category as $tc) : ?>
                                        <option value="<?= $tc->category_produk_key ?>"><?= $tc->category_produk_value ?></option>
                                      <?php endforeach; ?>
                                    </select>
                                  </div>
                                  <div class="col-md-12 mb-6">
                                    <label for="channel">History View Channel</label>
                                    <select  multiple data-allow-clear="1" name="channel[]" id="channel" class="form-control  multiple-paket " required>
                                      <option value="">-- Pilih Channel --</option>
                                      <?php foreach ($tampil_produk as $tc) : ?>
